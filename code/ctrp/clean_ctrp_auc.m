...
%% Change the cid to the cell line name
if ~isempty(args.new_cid)
    temp = ds_out.cid;
    ds_out.cid = ds_out.cdesc(:,ds_out.cdict(args.new_cid));
    ds_out = annotate_ds(ds_out,...
        struct('id',ds_out.cid,'original_id',temp),...
        'dim','column');
end
